...
public class Deck {
    ...
    private Vector<Card> initializeDeck(){
        ...
        for (int i = 0; i < 8; i++) {
            Card heart_card_1 = new Card("Ace of Hearts", "A♥", 1);
            ...
            Card diamond_card_1 = new Card("Ace of Diamonds", "A♦", 1);
            ...
            Card club_card_1 = new Card("Ace of Clubs", "A♣", 1);
            ...
            Card spades_card_1 = new Card("Ace of Spades", "A♠", 1);
